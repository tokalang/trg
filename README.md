...
- **macOS (Apple Silicon / arm64)**:
  - Direct Download: [`trg-v0.16.0-macos-arm64.tar.gz`](https://github.com/tokalang/trg/releases/download/v0.16.0/trg-v0.16.0-macos-arm64.tar.gz)
  ```bash
  curl -fLO https://github.com/tokalang/trg/releases/download/v0.16.0/trg-v0.16.0-macos-arm64.tar.gz
  tar -xzf trg-v0.16.0-macos-arm64.tar.gz
  ./trg-v0.16.0-macos-arm64/trg --version
  ```

- **Linux (x86_64)**:
  - Direct Download: [`trg-v0.16.0-linux-x64.tar.gz`](https://github.com/tokalang/trg/releases/download/v0.16.0/trg-v0.16.0-linux-x64.tar.gz)
  ```bash
  curl -fLO https://github.com/tokalang/trg/releases/download/v0.16.0/trg-v0.16.0-linux-x64.tar.gz
  tar -xzf trg-v0.16.0-linux-x64.tar.gz
  ./trg-v0.16.0-linux-x64/trg --version
  ```

- **Windows (x64)**:
  - Direct Download: [`trg-v0.16.0-windows-x64.zip`](https://github.com/tokalang/trg/releases/download/v0.16.0/trg-v0.16.0-windows-x64.zip)
  ```powershell
  curl.exe -fLO https://github.com/tokalang/trg/releases/download/v0.16.0/trg-v0.16.0-windows-x64.zip
  tar.exe -xf trg-v0.16.0-windows-x64.zip
  .\trg-v0.16.0-windows-x64\trg.exe --version
  ```

- **Windows (ARM64)**:
  - Direct Download: [`trg-v0.16.0-windows-arm64.zip`](https://github.com/tokalang/trg/releases/download/v0.16.0/trg-v0.16.0-windows-arm64.zip)
  ```powershell
  curl.exe -fLO https://github.com/tokalang/trg/releases/download/v0.16.0/trg-v0.16.0-windows-arm64.zip
  tar.exe -xf trg-v0.16.0-windows-arm64.zip
  .\trg-v0.16.0-windows-arm64\trg.exe --version
  ```

- **Checksums**:
  - Direct Download: [`SHA256SUMS`](https://github.com/tokalang/trg/releases/download/v0.16.0/SHA256SUMS)
...
Click to download [`trg-v0.16.0-windows-x64.zip`](https://github.com/tokalang/trg/releases/download/v0.16.0/trg-v0.16.0-windows-x64.zip) (or [`trg-v0.16.0-windows-arm64.zip`](https://github.com/tokalang/trg/releases/download/v0.16.0/trg-v0.16.0-windows-arm64.zip)), extract `trg.exe`, and drop it into any directory included in your system `PATH`.
